 ...
 */
public class CreditOrderItemDetailsDTO {
    ...
    public CreditOrderItemDetailsDTO(String orderItemDetailsId, String orderId, String itemCode, int qty, double sellingPrice) {
