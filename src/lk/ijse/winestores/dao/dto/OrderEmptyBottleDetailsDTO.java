 ...
 */
public class OrderEmptyBottleDetailsDTO {
    ...
    public OrderEmptyBottleDetailsDTO(String orderEmptyBottleEetailsId, String orderId, String bottleType, int qty, double total) {
